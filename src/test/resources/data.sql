...
INSERT INTO clients (
  ...
  (1, 'Jose Souza', '11122233344', 'CPF',     'PREPAID',  100.00, 0, 2, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (2, 'Company LTDA', '55566678000112', 'CNPJ', 'POSTPAID', 200.00, 0, 3, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
